...
<Notes>
  ...
  CRA (ok this might be an overkill reason but you get the idea 😏 )
...
<CenteredImage height={230} width={405} src={require("file-loader!./images/Igtft.gif")} />
